...
author: "Tyler Wallett, M.S. & Amir Jafari, PhD"
date: "today"
format: 
  html:
...
1. Implement Reinforcemeent Learning frameworks using NumPy and TensorFlow. <br>
2. Design decision-making systems using classical and deep learning architectures. <br>
3. Explain Reinforcement Learning taxonomy. <br>
...
- *Reinforcement Learning GitHub:* [Extra Materials](https://github.com/amir-jafari/Reinforcement-Learning/tree/main/08-ExtraMaterials)
...
|------------------|--------------------------------------------|-----------------|------------------------------------------------------|
| Aug 29, 2025 | Introduction to Reinforcement Learning | | - Course Outline  <br> - What is Reinforcement Learning?  <br> - Industry Applications  <br> - Taxonomy <br>|
...
| Sep 12, 2025 | Multi-Armed Bandits            | Quiz 1      | - Exploration vs. Exploitation  <br> - $\epsilon$-Greedy  <br> - Upper Confidence Boundary (UCB) <br> - Thompson Sampling |
| Sep 19, 2025 | Dynamic Programming            | Quiz 2      | - Markov Chain <br> - Markov Decision Process <br> - Value Functions <br> - Action Value Functions <br> - Bellman Equations <br> - Value Iteration |
